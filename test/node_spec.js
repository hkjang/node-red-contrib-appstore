...
describe('appstore node', function () {
    ...
    it('should be loaded', function (done) {
        var flow = [{ id: "n1", type: "appstore", name: "appstore" }];
        helper.load(node, flow, function () {
            var n1 = helper.getNode("n1");
            n1.should.have.property('name', 'appstore');
            done();
        });
    });
    ...
    it('should have payload', function (done) {
        var flow = [
            { id: "n1", type: "appstore", name: "appstore", wires: [["n2"]] },
            { id: "n2", type: "helper" }
        ];
        helper.load(node, flow, function () {
